      ...
      <div className="flex justify-between">
        ...
        <div className=''>
          <ul className='flex flex-row gap-4 text-lg'>
            ...
            <a href="#"><li className='rounded-sm hover:bg-gray-200 ease-in duration-300 px-6 py-2'>OJT</li></a>
            <a href="#"><li className='rounded-sm hover:bg-gray-200 ease-in duration-300 px-6 py-2'>Tite</li></a>
          </ul>
        </div>
      </div>
    </nav>
